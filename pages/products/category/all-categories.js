...
export default function ProductCatalogueCategory() {
    ...
    return <main className="w-full pb-10 bg-white font_urbanist overflow-hidden">
        <CatalogueCarousel />
        <section className='w-full p-5 md:p-7 lg:p-14 xl:p-16 2xl:p-24 h-full font_urbanist text-left' >
            <h1 className="font_urbanist_bold capitalize text-lg md:text-xl lg:text-2xl">{locale === "ar" ? "التسوق حسب الفئة" : "Shop By Category"}&nbsp;</h1>
