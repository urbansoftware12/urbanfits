...
export default function Accordian(props) {
    ...
    return <div className={props.className || " p-4 lg:p-6 outline-none accordion-section rounded-xl bg-gray-50 mb-6"} tabIndex={1}>
        <div onClick={() => setOpen(!open)} className="flex justify-between h-5 items-center transition ease duration-700 cursor-pointer relative">
            <div className={`text-sm lg:text-base font_urbanist_bold text-black transition ease duration-700`}>{props.title}</div>
